...
sudo apt-get install libapache2-mod-php php8.2 php8.2-fpm php8.2-common php8.2-xml php8.2-mysql php8.2-gd php8.2-mbstring php8.2-tokenizer php8.2-bcmath php8.2-curl php8.2-zip unzip -y
